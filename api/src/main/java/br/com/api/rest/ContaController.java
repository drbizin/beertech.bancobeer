...
public class ContaController {
    ...
    public Conta addTransacao(
            @ApiParam(name="hash", required=true, value="Hash", example="1")
    ...
    public Double getSaldo(@ApiParam(name="hash", required=true, value="Hash", example="1") @PathVariable String hash){
    ...
    @PostMapping(consumes={MediaType.APPLICATION_JSON_VALUE},
                 produces={MediaType.APPLICATION_JSON_VALUE})
    @ApiOperation(value="Criação de conta nova.", produces="application/json")

    public Conta criarConta(){

        return contaService.criacaoConta();
