...
public class RabbitConfig {
  ...
  @Bean
  public TopicExchange transfTopicExchange(){
  ...
  public Declarables declarablesBean(){
    ...
    Queue transfQueue = QueueBuilder.durable("transferencia").build();
    Binding transfBinding = BindingBuilder.bind(transfQueue).to(transfTopicExchange()).with(".");

    declarables.add(transfQueue);
    declarables.add(transfBinding);
